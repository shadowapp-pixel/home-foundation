...
export const metadata = {
  title: "Leadership | HOME Foundation",
  description:
    "Meet the executive director and board of directors guiding HOME Foundation's mission to preserve affordable housing in Maryland.",
};
